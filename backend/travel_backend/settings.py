...
ASGI_APPLICATION = 'travel_backend.asgi.application'
...
REST_FRAMEWORK = {
    ...
    # Add this to ensure proper handling in ASGI
...
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY',default='AIzaSyA7fjkOPze8lmUMi6l73MK_tI9k2ZObsVs')
NOMINATIM_USER_AGENT = config('NOMINATIM_USER_AGENT', default='travel_chatbot_app')

# ML Model Settings
HUGGINGFACE_MODEL_CACHE = config('HUGGINGFACE_MODEL_CACHE', default=str(BASE_DIR / 'ml_models/saved_models/'))
SENTENCE_TRANSFORMER_MODEL = config('SENTENCE_TRANSFORMER_MODEL', default='all-MiniLM-L6-v2')

# MFA Settings
MFA_ISSUER_NAME = config('MFA_ISSUER_NAME', default='TravelChatbot')
